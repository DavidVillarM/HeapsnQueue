...
/* Función auxiliar para intercambiar dos 
   elementos en el montículo */
void swap(PrioValue* a, PrioValue* b);

/* Función auxiliar para realizar el up-heap 
  (flotar hacia arriba) en el montículo */
void up_heap(PQ* pq, int index);

/* Función auxiliar para realizar el down-heap 
 (hundir hacia abajo) en el montículo */
